...
Um software simples com um site, um sistema de chat e calls e um serviço simples de login e registro. O projeto reúne os principais recursos necessários para uma aplicação de comunicação em uma única solução.
